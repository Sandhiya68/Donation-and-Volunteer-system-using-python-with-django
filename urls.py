"""
URL configuration for donvol project.
...
urlpatterns = [
    ...
    (template_name='password_reset_confirm.html',form_class=MySetPasswordForm),
    ...
    path("all-donatios/", views.all_donations, name="all_donations"),
    ...
    path('delete_donor/<int:donor_id>', views.delete_donation, name='delete_donor'),
